...
function TermekFelvitel() {
  ...
  const [keszlet, setKeszlet] = useState("");  // JAVÍTVA: keszlet, nem mennyiseg
  ...
  const kuldes = async (e) => {
    ...
    formData.append("keszlet", keszlet || 0);  // JAVÍTVA: keszlet, nem mennyiseg
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTermektipus("");
        setLeiras("");
        setKeszlet("");  // JAVÍTVA: keszlet reset
        setKep(null);
        setKepPreview(null);
